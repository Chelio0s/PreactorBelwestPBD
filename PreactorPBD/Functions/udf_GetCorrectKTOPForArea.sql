...
DECLARE @CorrectResult int
	SELECT @CorrectResult = CASE 
							WHEN @AreaId = 8 AND @KTOP <1000 THEN @KTOP + 5000
							WHEN @AreaId = 8 AND @KTOP > 5000 AND @KTOP <5999 THEN @KTOP
							WHEN @AreaId = 9 AND @KTOP <1000 THEN @KTOP + 1000
