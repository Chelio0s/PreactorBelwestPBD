...
public partial class UserDefinedFunctions
{
    [Microsoft.SqlServer.Server.SqlFunction(
        FillRowMethodName = "FillFinalRoutFromOtherPlace", SystemDataAccess = SystemDataAccessKind.Read,
        DataAccess = DataAccessKind.Read,
        TableDefinition = "KTOPParent int, " +
                          "KOBParent int," +
                          "KTOPChild int, " +
                          "KOBChild int ")]
    public static IEnumerable ctvf_GetFinalRoutForOtherPlaceSemiProduct(int idSemiProduct, int IdArea)
    {
            ...
            = new SqlConnection("context connection=true"))
        {
            ...
            command = new SqlCommand($"SELECT  *  FROM [InputData].[ctvf_GetMappingRulesForSemiProduct]({idSemiProduct}, {IdArea})",
                sqlConnection);
    ...
    public static void FillFinalRoutFromOtherPlace(object obj
