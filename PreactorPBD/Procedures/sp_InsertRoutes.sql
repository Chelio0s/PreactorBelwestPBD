...
(
	SELECT DISTINCT
        'ТМ с набором операций '+CONVERT(NVARCHAR(10), cc.RuleId) +'/'+ CONVERT(NVARCHAR(10), cc.RuleIsParent) + ' для ' + sp.Title + ' цех 1'  AS Title
	  ,[SemiProductId]
	  ,10
	  ,[CombineRulesId]
	  ,3
...
INSERT INTO [InputData].[Rout]
		   ...
		   ,ParentRouteId)
SELECT DISTINCT
'Альтернативный авто маршрут ' +  ' для цеха 6/1 для : '+ sp.Title 
, SemiProductId
, 10
, NULL
, 9
...
INSERT INTO [InputData].[Rout]
		   ...
		   ,ParentRouteId)
SELECT DISTINCT
'Альтернативный авто маршрут ' +  ' для цеха 7/1 для : '+ sp.Title 
, SemiProductId
, 10
, NULL
, 13
...
INSERT INTO [InputData].[Rout]
		   ...
		   ,ParentRouteId)
SELECT DISTINCT
'Альтернативный авто маршрут '+  ' для цеха 8/1 для : '+ sp.Title 
, SemiProductId
, 10
, NULL
, 14
...
INSERT INTO [InputData].[Rout]
		   ...
		   ,ParentRouteId)
SELECT DISTINCT
'Альтернативный авто маршрут ' +   ' для цеха 9/2 для : '+ sp.Title 
, SemiProductId
, 10
, NULL
, 20
